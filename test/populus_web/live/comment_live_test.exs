defmodule PopulusWeb.CommentLiveTest do
  use PopulusWeb.ConnCase

  import Phoenix.LiveViewTest
  import Populus.CommentsFixtures

  @create_attrs %{positive: 120.5, body: "some body", neutral: 120.5, negative: 120.5, named_entities: ["option1", "option2"]}
  @update_attrs %{positive: 456.7, body: "some updated body", neutral: 456.7, negative: 456.7, named_entities: ["option1"]}
  @invalid_attrs %{positive: nil, body: nil, neutral: nil, negative: nil, named_entities: []}
